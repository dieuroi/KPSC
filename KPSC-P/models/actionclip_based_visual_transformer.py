# Code borrowed from "ActionCLIP: ActionCLIP: A New Paradigm for Action Recognition"
# arXiv:
...
class visual_prompt(nn.Module):
    def __init__(self, sim_head, clip_state_dict, T):
        ...
        if self.sim_header == "Transf" :
            ...
            print('Using temporaltransformer, layer=6')
...
if __name__ == "__main__":
    ...
    import clip_code
    model, clip_state_dict = clip_code.load('checkpoints/ViT-B-32.pt', 
