...
from .actionclip_based_visual_transformer import *
...
if __name__ == "__main__":
    ...
    clip_path = 'checkpoints/ViT-B-32.pt'
    clip_model = load_clip_to_cpu(backbone_name, clip_path)
    dtype = clip_model.dtype
    clip_imsize = clip_model.visual.input_resolution
    classnames = ['bet', 'laptop', 'dog']
    n_ctx = 10
    ...
    print(embedding.shape)#([3, 77, 512])