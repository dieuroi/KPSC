...
if __name__ == "__main__":
    ...
    score_thr = 0.3
    datasets_root_path = '/SSD2T/Datasets/ActivityNet_raw_frames'

    json_list = ['../proposal_generation/activitynet/random_sample/ActivityNet_train_proposal_generation_selected_propoal_downline0.3_upline0.4.json_random0.25.json']

    save_list = ['./generated_nouns/ActivityNet_train_proposal_generation_selected_propoal_downline0.3_upline0.4.json_random0.25_tokens.json']
